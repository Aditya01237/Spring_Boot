  ...
  return (
    <div className="fixed inset-0 bg-gray-900 bg-opacity-70 flex justify-center items-center z-50 p-4">
      <div className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <p className="text-sm text-gray-600 mb-4">{placement.organisation}</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <textarea
              ...
              required
            ></textarea>
            <p className="text-xs text-gray-500 mt-1">{aboutText.length} characters</p>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center justify-center w-full">
              <label
                htmlFor="cvFile"
                className="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-blue-50 hover:border-blue-400 transition"
              >
                ...
                <input id="cvFile" type="file" accept=".pdf" className="hidden" onChange={handleFileChange} required />
              </label>
            </div>
            {cvFile && (
